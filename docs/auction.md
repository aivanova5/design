...
1. A Bid Price less than the Price Floor or greater than the Price Cap shall be rejected.
   1. The price resolution for power quantities shall be 1.0e-4 $/MWh, i.e., 1 hour maximum time, 100MW maximum quantity, and $0.01 minimum cost.
   1. The price resolution for energy quantities shall be 1.0e-8 $/MWh^2, i.e., 100 hours maximum time, 10GWh maximum quantity, and $0.01 minimum cost.
