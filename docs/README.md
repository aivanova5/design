...
flowchart TD
  ...
  agents[Agents]:::active --REST--> gateway[API Gateway]
      click agents "https://github.com/tess-cc/design/blob/main/docs/agents.md" _blank
  ...
  controllers([Controllers]) --HTTPS--> controller_app[Controller App]:::active --REST--> gateway
      click controller_app "https://github.com/tess-cc/design/blob/main/docs/controllers.md" _blank

  billing([Billing User]) --HTTPS--> billing_app[Billing App]:::active --REST--> gateway
      click billing_app "https://github.com/tess-cc/design/blob/main/docs/billing.md" _blank

  monitors([Monitors]) --HTTPS--> monitor_app[Monitor App]:::active --REST--> gateway
      click monitor_app "https://github.com/tess-cc/design/blob/main/docs/monitors.md" _blank

  experiment([Experimenters]) --HTTPS--> experiment_app[Experiment App]:::active --REST--> gateway
      click experiment_app "https://github.com/tess-cc/design/blob/main/docs/experimenters.md" _blank

  gateway --> auth[Cognito]
  
  gateway --> s3[S3]
    s3 --> websites([Websites]):::active
      click websites "https://github.com/tess-cc/design/blob/main/docs/websites.md" _blank
  ...
  gateway --> lambda[Lambda]
    ...
    lambda --> auction[Auction]:::active
      click auction "https://github.com/tess-cc/design/blob/main/docs/auction.md" _blank
      auction --API--> database  
    lambda --> device[Device]:::active
      click device "https://github.com/tess-cc/design/blob/main/docs/device.md" _blank
      device --API--> database[(Database)]:::active
      click database "https://github.com/tess-cc/design/blob/main/docs/database.md" _blank
...
flowchart LR
  ...
  agent[Agent]:::active --"REST"--> auction[Auction]:::active
    click agent "https://github.co/tess-cc/design/blob/main/docs/agent.md" _blank
    click auction "https://github.com/tess-cc/design/blob/main/docs/auction.md" _blank
  ...
  user([User]) --HTTPS--> user_app[User App]:::active --REST--> database_api[db_api]:::active --SQL--> database
    click user_app "https://github.com/tess-cc/design/blob/main/docs/users.md" _blank
    click db_api "https://github.co/tess-cc/design/blob/main/docs/database.md" _blank

  controller([Controller]) --HTTPS--> controller_app[Controller App]:::active --REST--> database_api
      click controller_app "https://github.com/tess-cc/design/blob/main/docs/controller.md" _blank
